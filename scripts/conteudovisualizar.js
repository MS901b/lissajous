	var codigo_do_software = "lissajous";
	var nome_do_software = "As curvas de Lissajous";
	...
	var FichaTecnica = $H({
		...
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Neste software, o aluno utilizará equações paramétricas para compreender como funcionam as curvas de Lissajous, que possuem um forte apelo visual. Também serão estudados os contextos em que elas podem ser aplicadas.'
		},
		conteudos: {
			titulo: 'Conteúdo',
			conteudo: 'Gráﬁcos de funções; Curvas parametrizadas; Funções trigonométricas; Funções periódicas.'
		},
		objetivos: {
			titulo: 'Objetivos',
			conteudo: 'Entender um exemplo de combinação de funções; Introduzir e interpretar curvas parametrizadas; Reconhecer períodos e frequências em funções periódicas.'
		},
		duracao: {
			titulo: 'Duração',
